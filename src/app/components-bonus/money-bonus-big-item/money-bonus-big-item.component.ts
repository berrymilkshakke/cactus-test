...
@Component({
  selector: 'app-money-bonus-big-item',
  templateUrl: './money-bonus-big-item.component.html',
  styleUrls: ['./money-bonus-big-item.component.scss'],
  encapsulation: ViewEncapsulation.None
})
export class MoneyBonusBigItemComponent implements OnInit {
