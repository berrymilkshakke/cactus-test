...
@Component({
  selector: 'app-fs-bonus-big-item',
  templateUrl: './fs-bonus-big-item.component.html',
  styleUrls: ['./fs-bonus-big-item.component.scss'],
  encapsulation: ViewEncapsulation.None
})
export class FsBonusBigItemComponent implements OnInit {
  ...
  @Output() public bonusActivatedEvent: EventEmitter<object> = new EventEmitter();
  ...
  getImagePatch(imageName: string) {
    return `${this.cdnServer}/promo_big/${imageName}`;
  }
