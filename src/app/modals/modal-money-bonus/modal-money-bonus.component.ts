...
@Component({
  selector: 'app-modal-money-bonus',
  templateUrl: './modal-money-bonus.component.html',
  styleUrls: ['./modal-money-bonus.component.scss'],
  encapsulation: ViewEncapsulation.None
})
export class ModalMoneyBonusComponent implements OnInit {
