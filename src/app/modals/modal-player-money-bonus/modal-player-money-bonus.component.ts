...
@Component({
  selector: 'app-modal-player-money-bonus',
  templateUrl: './modal-player-money-bonus.component.html',
  styleUrls: ['./modal-player-money-bonus.component.scss'],
  encapsulation: ViewEncapsulation.None
})
export class ModalPlayerMoneyBonusComponent implements OnInit {
