...
@Component({
  selector: 'app-faq-registration',
  templateUrl: './faq-registration.component.html',
  styleUrls: ['./faq-registration.component.scss'],
  encapsulation: ViewEncapsulation.None
})
export class FaqRegistrationComponent implements OnInit {

  public faq: any;

  public componentName: string = 'faq-registration';
