...
export class GamesListComponent implements OnInit, OnChanges {
  ...
  public limitCountInit: number = 42;
  public limitCountMore: number = 6 * 7;
  ...
  ngOnInit() {
    ...
    if (this.isSimple) {
      ...
      this.limitCountInit = 42;
      this.limitCountMore = 6 * 7;
    }
  ...
  /*
  getFavoriteGames(brandName) {
    let gamesArrayFiltered = this.favoriteGames;
