...
@Component({
  selector: 'app-banner-registration',
  templateUrl: './banner-registration.component.html',
  styleUrls: ['./banner-registration.component.scss'],
  encapsulation: ViewEncapsulation.None
})
export class BannerRegistrationComponent implements OnInit {
